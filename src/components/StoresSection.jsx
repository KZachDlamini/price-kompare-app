...
function StoresSection() {
  const stores = ["Pick n Pay", "Checkers", "Shoprite", "Spar", "Makro", "Woolworths"]; // Added Woolworths for variety

  return (
    <section className="stores py-10 bg-white shadow-sm">
      <div className="container mx-auto px-4">
        <h2 className="text-center text-3xl font-semibold text-gray-800 mb-8">Popular Stores</h2>
